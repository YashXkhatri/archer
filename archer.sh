...
username="yash"     # Main user
device="/dev/sda"   # Drive for install (/dev/nvme0n1, /dev/sda, etc)
language="en_US"        # Language for locale.conf
locale="en_US"          # Numbers, messurement, etc. for locale.conf
keymap="no"             # Keymap (localectl list-keymaps)
timezone="Asia/Kolkata"  # Timezone (located in /usr/share/zoneinfo/../..)
swapsize="2g"         # Size of swap file (accepting k/m/g/e/p suffix, auto=MemTotal, 0=no swap)
...
# ------------------------------------------------------------------------------
pkglist=(
    "https://raw.githubusercontent.com/YashXkhatri/archer/refs/heads/main/pkg/pkglist.txt"
